  ...
  return (
    <div className="max-w-7xl mx-auto animate-fade-in">
      ...
      <div className="grid lg:grid-cols-2 gap-8 mb-8">
          ...
          <div className="bg-gradient-to-br from-orange-900/30 to-red-900/30 p-6 rounded-2xl border border-orange-500/40">
            ...
            <div className="space-y-4">
              <div className="border-l-4 border-orange-500 pl-4">
                ...
                <p className="text-gray-400">Unitate principală - web server, cameră, interfață</p>
              </div>
        ...
        <div className="space-y-6">
          <div className="grid grid-cols-2 gap-4">
            <div className="bg-slate-800/50 backdrop-blur-sm p-4 rounded-xl border border-orange-500/30">
              <h3 className="text-lg font-bold text-orange-400 mb-3">Flask Server</h3>
            ...
            <div className="bg-slate-800/50 backdrop-blur-sm p-4 rounded-xl border border-purple-500/30">
              <h3 className="text-lg font-bold text-purple-400 mb-3">VideoCamera Class</h3>
              <div className="bg-gray-900 rounded-lg overflow-hidden shadow-2xl">
                <img 
      ...
      <div className="bg-gradient-to-r from-green-900/20 to-emerald-900/20 p-6 rounded-2xl border border-green-500/30">
        <h3 className="text-2xl font-bold text-green-400 mb-4 text-center">Comunicare & Tehnologii</h3>
        <div className="grid grid-cols-3 gap-6 text-center">
          <div className="space-y-2">
            <div className="w-12 h-12 bg-green-500 rounded-full flex items-center justify-center mx-auto">
              <span className="text-xl">🔗</span>
            </div>
            <h4 className="text-lg font-bold text-green-400">Comunicare</h4>
            <p className="text-gray-300">Pi-Arduino prin USB</p>
          </div>
          <div className="space-y-2">
            <div className="w-12 h-12 bg-blue-500 rounded-full flex items-center justify-center mx-auto">
              <span className="text-xl">📱</span>
            </div>
            <h4 className="text-lg font-bold text-blue-400">Interfață</h4>
          ...
          <div className="space-y-2">
            ...
            <h4 className="text-lg font-bold text-orange-400">Structură</h4>
            <p className="text-gray-300">Python (Pi) & C++ (Arduino)</p>
          </div>
        </div>
      </div>
    </div>
